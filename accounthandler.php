...
if ($method == "login") {
    ...
    $sql = "select id,email,username,nome,cognome,password from utente where username = '$userid' or email = '$userid'";
    ...
    if($currentemail != $newemail){
        ...
        if(mysqli_affected_rows($conn) > 0){
            ...
            $sql = "UPDATE utente SET email = '$newemail' WHERE id = '$currentuserid'";
    ...
    if($currentusername != $newusername){
        ...
        if(mysqli_affected_rows($conn) > 0){
            ...
            $sql = "UPDATE utente SET username = '$newusername' WHERE id = '$currentuserid'";
    ...
    if($currentname != $newname){
        ...
        $sql = "UPDATE utente SET nome = '$newname' WHERE id = '$currentuserid'";
    ...
    if($currentsurname != $newsurname){
        $sql = "UPDATE utente SET cognome = '$newsurname' WHERE id = '$currentuserid'";
    ...
    if(isValid($newpass) && isValid($oldpass)){
        ...
        if($oldpass != $currentpass){
            ...
            $sql = "UPDATE utente SET password = '$newpass' WHERE id = '$currentuserid'";
